...
#define UART_REMOVE_SPI_MASTER_PINS         (0u)
#define UART_REMOVE_SPI_MASTER_SCLK_PIN     (0u)
#define UART_REMOVE_SPI_MASTER_MOSI_PIN     (0u)
#define UART_REMOVE_SPI_MASTER_MISO_PIN     (0u)
#define UART_REMOVE_SPI_MASTER_SS0_PIN      (0u)
